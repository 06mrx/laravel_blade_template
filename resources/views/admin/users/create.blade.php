        ...
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <select name="plan_type" id="plan_type"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <option value="free" {{ old('plan_type') == 'free' ? 'selected' : '' }}>Free</option>
            ...
            <!-- Subscription Start -->
            <div class="mb-6">
                <label for="subscription_start" class="block text-sm font-medium text-gray-700 mb-1">Subscription
                    Start</label>
            ...
            <div class="mb-6">
                ...
                <input type="date" name="subscription_end" id="subscription_end" value="{{ old('subscription_end') }}"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="mb-6">
                ...
                <input type="date" name="trial_ends_at" id="trial_ends_at" value="{{ old('trial_ends_at') }}"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                @error('trial_ends_at')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            ...
            <div class="mb-6">
                ...
                <input type="number" name="max_mikrotiks" id="max_mikrotiks" value="{{ old('max_mikrotiks') }}"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="e.g. 3">
                @error('max_mikrotiks')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
            ...
            <div class="mb-6">
                ...
                <input type="number" name="max_customers" id="max_customers" value="{{ old('max_customers') }}"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="e.g. 100">
                @error('max_customers')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
