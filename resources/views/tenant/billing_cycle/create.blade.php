...
@section('title', 'Tambah Skema Penagihan')

@section('content')
    <div class="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-lg">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Tambah Skema Penagihan</h1>

        <form action="{{ route('tenant.billing_cycle.store') }}" method="POST">
            @csrf
            ...
            <!-- Tanggal Jatuh Tempo -->
            <div class="mb-6" id="due-days-field">
                <label for="due_days" class="block text-sm font-medium text-gray-700 mb-2">Tanggal Jatuh Tempo (pisahkan dengan koma)</label>
