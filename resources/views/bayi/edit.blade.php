...
@section('page-title', 'Edit Data Bayi')

@section('content')
    <div class="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md">
        <form action="{{ route('bayi.update', $bayi) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <div class="flex space-x-6">
                    <label class="inline-flex items-center">
                        <input type="radio" name="jk" value="L" {{ old('jk', $bayi->jk) == 'L' ? 'checked' : '' }} class="form-radio h-4 w-4 text-blue-600" required>
                        <span class="ml-2 text-sm text-gray-700">Laki-laki</span>
                    </label>
                    <label class="inline-flex items-center">
                        <input type="radio" name="jk" value="P" {{ old('jk', $bayi->jk) == 'P' ? 'checked' : '' }} class="form-radio h-4 w-4 text-blue-600" required>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_ortu" id="nama_ortu"
                       value="{{ old('nama_ortu', $bayi->nama_ortu) }}"
                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div class="mb-4">
                ...
                <textarea name="ket" id="ket" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                          placeholder="Catatan tambahan">{{ old('ket', $bayi->ket) }}</textarea>
            </div>
